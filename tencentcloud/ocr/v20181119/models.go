...
type ClassifyStoreNameRequestParams struct {
	...
	SceneType *bool `json:"SceneType,omitnil,omitempty" name:"SceneType"`

	// <p>输入商户名称，辅助判断具体场景标签。注：仅SceneType配置为true时支持。</p>
	StoreInfo *string `json:"StoreInfo,omitnil,omitempty" name:"StoreInfo"`
}
...
func (r *ClassifyStoreNameRequest) FromJsonString(s string) error {
	...
	delete(f, "StoreInfo")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ClassifyStoreNameRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
type CropEnhanceImageOCRResponseParams struct {
	...
	CroppedImageUrl *string `json:"CroppedImageUrl,omitnil,omitempty" name:"CroppedImageUrl"`
...
func (r *IDCardOCRRequest) FromJsonString(s string) error {
	...
	delete(f, "EnableDateVerify")
	delete(f, "CardWarnType")
	if len(f) > 0 {
...
func (r *QuestionOCRRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "QuestionOCRRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *QuestionSplitLayoutOCRRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "QuestionSplitLayoutOCRRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *RecognizeFormulaOCRRequest) FromJsonString(s string) error {
	...
	delete(f, "PdfPageNumber")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "RecognizeFormulaOCRRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *RecognizeStoreNameRequest) FromJsonString(s string) error {
	...
	delete(f, "ImageUrl")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "RecognizeStoreNameRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
type SubmitQuestionMarkAgentJobRequestParams struct {
	...
	AssistMarkType *int64 `json:"AssistMarkType,omitnil,omitempty" name:"AssistMarkType"`
	...
	AnswerAssistMap *string `json:"AnswerAssistMap,omitnil,omitempty" name:"AnswerAssistMap"`
}
...
func (r *SubmitQuestionMarkAgentJobRequest) FromJsonString(s string) error {
	...
	delete(f, "ImageBase64List")
	delete(f, "ImageUrlList")
	delete(f, "AssistMarkType")
	delete(f, "AnswerAssistMap")
	if len(f) > 0 {
...
// Predefined struct for user
type VerifyGeneralCardWarnRequestParams struct {
...
type VerifyGeneralCardWarnRequest struct {
	*tchttp.BaseRequest
...
func (r *VerifyGeneralCardWarnRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *VerifyGeneralCardWarnRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ImageBase64")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "VerifyGeneralCardWarnRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type VerifyGeneralCardWarnResponseParams struct {
	// <p>区域篡改提示</p>
	Tamper *GeneralCardWarnInfo `json:"Tamper,omitnil,omitempty" name:"Tamper"`

	// <p>AIGC合成提示</p>
	Synthesis *GeneralCardWarnInfo `json:"Synthesis,omitnil,omitempty" name:"Synthesis"`

	// <p>模板图片提示</p>
	Template *GeneralCardWarnInfo `json:"Template,omitnil,omitempty" name:"Template"`

	// <p>屏幕翻拍提示</p>
	RemakeScreen *GeneralCardWarnInfo `json:"RemakeScreen,omitnil,omitempty" name:"RemakeScreen"`
	...
	// <p>文字水印提示</p>
	TextWatermark *GeneralCardWarnInfo `json:"TextWatermark,omitnil,omitempty" name:"TextWatermark"`
...
type VerifyGeneralCardWarnResponse struct {
	*tchttp.BaseResponse
	Response *VerifyGeneralCardWarnResponseParams `json:"Response"`
}

func (r *VerifyGeneralCardWarnResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *VerifyGeneralCardWarnResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
